...
sed -i '12i  'default_phone_region' => 'IN',' /var/www/nextcloud/config/config.php
sed -i '13i  'memcache.local' => '\OC\Memcache\APCu',' /var/www/nextcloud/config/config.php
sed -i '14i  'htaccess.RewriteBase' => '/',' /var/www/nextcloud/config/config.php
